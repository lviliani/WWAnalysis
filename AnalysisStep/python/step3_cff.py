...
def addGenVVVariables(process,pt):
    if hasattr(pt,"variables"):
        ...
        setattr(pt.variables, "genVV_Inc1lepton1_pt"    , cms.string("genVVIncS1LeptonPt(0)")),
        setattr(pt.variables, "genVV_Inc1lepton1_pid"   , cms.string("genVVIncS1LeptonPID(0)")),
        setattr(pt.variables, "genVV_Inc1lepton1_phi"   , cms.string("genVVIncS1LeptonPhi(0)")),
        setattr(pt.variables, "genVV_Inc1lepton1_eta"   , cms.string("genVVIncS1LeptonEta(0)")),
        setattr(pt.variables, "genVV_Inc1lepton1_imTau"   , cms.string("genVVIncS1LeptonimTau(0)")),
        setattr(pt.variables, "genVV_Inc1lepton1_oVpid"   , cms.string("genVVIncS1LeptonoVPID(0)")),
        setattr(pt.variables, "genVV_Inc1lepton2_pt"    , cms.string("genVVIncS1LeptonPt(1)")),
        setattr(pt.variables, "genVV_Inc1lepton2_pid"   , cms.string("genVVIncS1LeptonPID(1)")),
        setattr(pt.variables, "genVV_Inc1lepton2_phi"   , cms.string("genVVIncS1LeptonPhi(1)")),
        setattr(pt.variables, "genVV_Inc1lepton2_eta"   , cms.string("genVVIncS1LeptonEta(1)")),
        setattr(pt.variables, "genVV_Inc1lepton2_imTau"   , cms.string("genVVIncS1LeptonimTau(1)")),
        setattr(pt.variables, "genVV_Inc1lepton2_oVpid"   , cms.string("genVVIncS1LeptonoVPID(1)")),
        setattr(pt.variables, "genVV_Inc1lepton3_pt"    , cms.string("genVVIncS1LeptonPt(2)")),
        setattr(pt.variables, "genVV_Inc1lepton3_pid"   , cms.string("genVVIncS1LeptonPID(2)")),
        setattr(pt.variables, "genVV_Inc1lepton3_phi"   , cms.string("genVVIncS1LeptonPhi(2)")),
        setattr(pt.variables, "genVV_Inc1lepton3_eta"   , cms.string("genVVIncS1LeptonEta(2)")),
        setattr(pt.variables, "genVV_Inc1lepton3_imTau"   , cms.string("genVVIncS1LeptonimTau(2)")),
        setattr(pt.variables, "genVV_Inc1lepton3_oVpid"   , cms.string("genVVIncS1LeptonoVPID(2)")),
