...
#        pmvamet = cms.string("projMvaMet"),
        ...
        pfmetTypeI  = cms.string("pfMetTypeI"),
        pfmetTypeIphi  = cms.string("pfMetTypeIPhi"),
        ...
        #jetpt5   = cms.string("leadingJetPt(4,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jeteta5  = cms.string("leadingJetEta(4,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetphi5  = cms.string("leadingJetPhi(4,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetmass5 = cms.string("leadingJetMass(4,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetid5   = cms.string("leadingJetId(4,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetmva5  = cms.string("leadingJetMva(4,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jettche5 = cms.string("leadingJetBtag(4,'trackCountingHighEffBJetTags',0,"+CJVmaxEta+",1,"+jetId_WP+","+DzBVeto+")"),
        #jetbjpb5 = cms.string("leadingJetBtag(4,'jetBProbabilityBJetTags',0,"+CJVmaxEta+",1,"+jetId_WP+","+DzBVeto+")"),
        #jettchp5 = cms.string("leadingJetBtag(4,'trackCountingHighPurBJetTags',0,"+CJVmaxEta+",1,"+jetId_WP+","+DzBVeto+")"),
        #jetptd5 = cms.string("leadingJetPtd(4,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetCHM5 = cms.string("leadingJetChargedHadronMultiplicity(4,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetNHM5 = cms.string("leadingJetNeutralHadronMultiplicity(4,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetPhM5 = cms.string("leadingJetPhotonMultiplicity(4,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetQCptD5 = cms.string("leadingJetPtD(4,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetQCaxis15   = cms.string("leadingJetQGaxis1(4,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetQCaxis25   = cms.string("leadingJetQGaxis2(4,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetQCRMScand5 = cms.string("leadingJetQGRMScand(4,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetQCRmax5    = cms.string("leadingJetQGRmax(4,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetptD5 = cms.string("leadingJetPtD(4,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
        #jetaxis15   = cms.string("leadingJetQGaxis1(4,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
        #jetaxis25   = cms.string("leadingJetQGaxis2(4,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
        #jetRMScand5 = cms.string("leadingJetQGRMScand(4,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
        #jetRmax5    = cms.string("leadingJetQGRmax(4,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),

        #jetpt6   = cms.string("leadingJetPt(5,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jeteta6  = cms.string("leadingJetEta(5,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetphi6  = cms.string("leadingJetPhi(5,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetmass6 = cms.string("leadingJetMass(5,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetid6   = cms.string("leadingJetId(5,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetmva6  = cms.string("leadingJetMva(5,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jettche6 = cms.string("leadingJetBtag(5,'trackCountingHighEffBJetTags',0,"+CJVmaxEta+",1,"+jetId_WP+","+DzBVeto+")"),
        #jetbjpb6 = cms.string("leadingJetBtag(5,'jetBProbabilityBJetTags',0,"+CJVmaxEta+",1,"+jetId_WP+","+DzBVeto+")"),
        #jettchp6 = cms.string("leadingJetBtag(5,'trackCountingHighPurBJetTags',0,"+CJVmaxEta+",1,"+jetId_WP+","+DzBVeto+")"),
        #jetptd6 = cms.string("leadingJetPtd(5,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetCHM6 = cms.string("leadingJetChargedHadronMultiplicity(5,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetNHM6 = cms.string("leadingJetNeutralHadronMultiplicity(5,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetPhM6 = cms.string("leadingJetPhotonMultiplicity(5,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetQCptD6 = cms.string("leadingJetPtD(5,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetQCaxis16   = cms.string("leadingJetQGaxis1(5,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetQCaxis26   = cms.string("leadingJetQGaxis2(5,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetQCRMScand6 = cms.string("leadingJetQGRMScand(5,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetQCRmax6    = cms.string("leadingJetQGRmax(5,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetptD6 = cms.string("leadingJetPtD(5,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
        #jetaxis16   = cms.string("leadingJetQGaxis1(5,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
        #jetaxis26   = cms.string("leadingJetQGaxis2(5,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
        #jetRMScand6 = cms.string("leadingJetQGRMScand(5,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
        #jetRmax6    = cms.string("leadingJetQGRmax(5,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),

        #jetpt7   = cms.string("leadingJetPt(6,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jeteta7  = cms.string("leadingJetEta(6,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetphi7  = cms.string("leadingJetPhi(6,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetmass7 = cms.string("leadingJetMass(6,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetid7   = cms.string("leadingJetId(6,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetmva7  = cms.string("leadingJetMva(6,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jettche7 = cms.string("leadingJetBtag(6,'trackCountingHighEffBJetTags',0,"+CJVmaxEta+",1,"+jetId_WP+","+DzBVeto+")"),
        #jetbjpb7 = cms.string("leadingJetBtag(6,'jetBProbabilityBJetTags',0,"+CJVmaxEta+",1,"+jetId_WP+","+DzBVeto+")"),
        #jettchp7 = cms.string("leadingJetBtag(6,'trackCountingHighPurBJetTags',0,"+CJVmaxEta+",1,"+jetId_WP+","+DzBVeto+")"),
        #jetptd7 = cms.string("leadingJetPtd(6,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetCHM7 = cms.string("leadingJetChargedHadronMultiplicity(6,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetNHM7 = cms.string("leadingJetNeutralHadronMultiplicity(6,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetPhM7 = cms.string("leadingJetPhotonMultiplicity(6,0,"+CJVmaxEta+",1,"+jetId_WP+")"),
        #jetQCptD7 = cms.string("leadingJetPtD(6,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetQCaxis17   = cms.string("leadingJetQGaxis1(6,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetQCaxis27   = cms.string("leadingJetQGaxis2(6,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetQCRMScand7 = cms.string("leadingJetQGRMScand(6,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetQCRmax7    = cms.string("leadingJetQGRmax(6,0,"+CJVmaxEta+",1,"+jetId_WP+",1)"),
        #jetptD7 = cms.string("leadingJetPtD(6,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
        #jetaxis17   = cms.string("leadingJetQGaxis1(6,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
        #jetaxis27   = cms.string("leadingJetQGaxis2(6,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
        #jetRMScand7 = cms.string("leadingJetQGRMScand(6,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
        #jetRmax7    = cms.string("leadingJetQGRmax(6,0,"+CJVmaxEta+",1,"+jetId_WP+",0)"),
...
def addGenVariables(process,pt):
    if hasattr(pt,"variables"):
        ...
        setattr(pt.variables, "jetGenPartonpt4"    , cms.string("leadingGenJetPartonPt(3)")),
        setattr(pt.variables, "jetGenPartonpid4"   , cms.string("leadingGenJetPartonPID(3)")),
        setattr(pt.variables, "jetGenPartonphi4"   , cms.string("leadingGenJetPartonPhi(3)")),
        setattr(pt.variables, "jetGenPartoneta4"   , cms.string("leadingGenJetPartonEta(3)")),
        setattr(pt.variables, "jetGenPartonpt5"    , cms.string("leadingGenJetPartonPt(4)")),
        setattr(pt.variables, "jetGenPartonpid5"   , cms.string("leadingGenJetPartonPID(4)")),
        setattr(pt.variables, "jetGenPartonphi5"   , cms.string("leadingGenJetPartonPhi(4)")),
        setattr(pt.variables, "jetGenPartoneta5"   , cms.string("leadingGenJetPartonEta(4)")),
        setattr(pt.variables, "jetGenPartonpt6"    , cms.string("leadingGenJetPartonPt(5)")),
        setattr(pt.variables, "jetGenPartonpid6"   , cms.string("leadingGenJetPartonPID(5)")),
        setattr(pt.variables, "jetGenPartonphi6"   , cms.string("leadingGenJetPartonPhi(5)")),
        setattr(pt.variables, "jetGenPartoneta6"   , cms.string("leadingGenJetPartonEta(5)")),
        setattr(pt.variables, "jetGenPartonpt7"    , cms.string("leadingGenJetPartonPt(6)")),
        setattr(pt.variables, "jetGenPartonpid7"   , cms.string("leadingGenJetPartonPID(6)")),
        setattr(pt.variables, "jetGenPartonphi7"   , cms.string("leadingGenJetPartonPhi(6)")),
        setattr(pt.variables, "jetGenPartoneta7"   , cms.string("leadingGenJetPartonEta(6)")),
        setattr(pt.variables, "jetGenPartonpt8"    , cms.string("leadingGenJetPartonPt(7)")),
        setattr(pt.variables, "jetGenPartonpid8"   , cms.string("leadingGenJetPartonPID(7)")),
        setattr(pt.variables, "jetGenPartonphi8"   , cms.string("leadingGenJetPartonPhi(7)")),
        setattr(pt.variables, "jetGenPartoneta8"   , cms.string("leadingGenJetPartonEta(7)")),
        setattr(pt.variables, "jetGenPartonpt9"    , cms.string("leadingGenJetPartonPt(8)")),
        setattr(pt.variables, "jetGenPartonpid9"   , cms.string("leadingGenJetPartonPID(8)")),
        setattr(pt.variables, "jetGenPartonphi9"   , cms.string("leadingGenJetPartonPhi(8)")),
        setattr(pt.variables, "jetGenPartoneta9"   , cms.string("leadingGenJetPartonEta(8)")),


        setattr(pt.variables, "jetGenPartonBpt1"    , cms.string("leadingGenJetPartonBPt(0)")),
        setattr(pt.variables, "jetGenPartonBphi1"   , cms.string("leadingGenJetPartonBPhi(0)")),
        setattr(pt.variables, "jetGenPartonBeta1"   , cms.string("leadingGenJetPartonBEta(0)")),
        setattr(pt.variables, "jetGenPartonBpt2"    , cms.string("leadingGenJetPartonBPt(1)")),
        setattr(pt.variables, "jetGenPartonBphi2"   , cms.string("leadingGenJetPartonBPhi(1)")),
        setattr(pt.variables, "jetGenPartonBeta2"   , cms.string("leadingGenJetPartonBEta(1)")),
        setattr(pt.variables, "jetGenPartonBpt3"    , cms.string("leadingGenJetPartonBPt(2)")),
        setattr(pt.variables, "jetGenPartonBphi3"   , cms.string("leadingGenJetPartonBPhi(2)")),
        setattr(pt.variables, "jetGenPartonBeta3"   , cms.string("leadingGenJetPartonBEta(2)")),
        setattr(pt.variables, "jetGenPartonBpt4"    , cms.string("leadingGenJetPartonBPt(3)")),
        setattr(pt.variables, "jetGenPartonBphi4"   , cms.string("leadingGenJetPartonBPhi(3)")),
        setattr(pt.variables, "jetGenPartonBeta4"   , cms.string("leadingGenJetPartonBEta(3)")),
...
# gen information
def addGenVVVariables(process,pt):
    if hasattr(pt,"variables"):
        setattr(pt.variables, "genVV_jet1_parton_pt"    , cms.string("leadingGenJetPartonPt(0)")),
        setattr(pt.variables, "genVV_jet1_parton_pid"   , cms.string("leadingGenJetPartonPID(0)")),
        setattr(pt.variables, "genVV_jet1_parton_phi"   , cms.string("leadingGenJetPartonPhi(0)")),
        setattr(pt.variables, "genVV_jet1_parton_eta"   , cms.string("leadingGenJetPartonEta(0)")),
        setattr(pt.variables, "genVV_jet2_parton_pt"    , cms.string("leadingGenJetPartonPt(1)")),
        setattr(pt.variables, "genVV_jet2_parton_pid"   , cms.string("leadingGenJetPartonPID(1)")),
        setattr(pt.variables, "genVV_jet2_parton_phi"   , cms.string("leadingGenJetPartonPhi(1)")),
        setattr(pt.variables, "genVV_jet2_parton_eta"   , cms.string("leadingGenJetPartonEta(1)")),
        setattr(pt.variables, "genVV_jet3_parton_pt"    , cms.string("leadingGenJetPartonPt(2)")),
        setattr(pt.variables, "genVV_jet3_parton_pid"   , cms.string("leadingGenJetPartonPID(2)")),
        setattr(pt.variables, "genVV_jet3_parton_phi"   , cms.string("leadingGenJetPartonPhi(2)")),
        setattr(pt.variables, "genVV_jet3_parton_eta"   , cms.string("leadingGenJetPartonEta(2)")),
        setattr(pt.variables, "genVV_jet4_parton_pt"    , cms.string("leadingGenJetPartonPt(3)")),
        setattr(pt.variables, "genVV_jet4_parton_pid"   , cms.string("leadingGenJetPartonPID(3)")),
        setattr(pt.variables, "genVV_jet4_parton_phi"   , cms.string("leadingGenJetPartonPhi(3)")),
        setattr(pt.variables, "genVV_jet4_parton_eta"   , cms.string("leadingGenJetPartonEta(3)")),
        setattr(pt.variables, "genVV_jet5_parton_pt"    , cms.string("leadingGenJetPartonPt(4)")),
        setattr(pt.variables, "genVV_jet5_parton_pid"   , cms.string("leadingGenJetPartonPID(4)")),
        setattr(pt.variables, "genVV_jet5_parton_phi"   , cms.string("leadingGenJetPartonPhi(4)")),
        setattr(pt.variables, "genVV_jet5_parton_eta"   , cms.string("leadingGenJetPartonEta(4)")),

        setattr(pt.variables, "genVV_lepton1_pt"    , cms.string("genVVLeptonPt(0)")),
        setattr(pt.variables, "genVV_lepton1_pid"   , cms.string("genVVLeptonPID(0)")),
        setattr(pt.variables, "genVV_lepton1_phi"   , cms.string("genVVLeptonPhi(0)")),
        setattr(pt.variables, "genVV_lepton1_eta"   , cms.string("genVVLeptonEta(0)")),
        setattr(pt.variables, "genVV_lepton1_imTau"   , cms.string("genVVLeptonimTau(0)")),
        setattr(pt.variables, "genVV_lepton1_oVpid"   , cms.string("genVVLeptonoVPID(0)")),
        setattr(pt.variables, "genVV_lepton2_pt"    , cms.string("genVVLeptonPt(1)")),
        setattr(pt.variables, "genVV_lepton2_pid"   , cms.string("genVVLeptonPID(1)")),
        setattr(pt.variables, "genVV_lepton2_phi"   , cms.string("genVVLeptonPhi(1)")),
        setattr(pt.variables, "genVV_lepton2_eta"   , cms.string("genVVLeptonEta(1)")),
        setattr(pt.variables, "genVV_lepton2_imTau"   , cms.string("genVVLeptonimTau(1)")),
        setattr(pt.variables, "genVV_lepton2_oVpid"   , cms.string("genVVLeptonoVPID(1)")),
        setattr(pt.variables, "genVV_lepton3_pt"    , cms.string("genVVLeptonPt(2)")),
        setattr(pt.variables, "genVV_lepton3_pid"   , cms.string("genVVLeptonPID(2)")),
        setattr(pt.variables, "genVV_lepton3_phi"   , cms.string("genVVLeptonPhi(2)")),
        setattr(pt.variables, "genVV_lepton3_eta"   , cms.string("genVVLeptonEta(2)")),
        setattr(pt.variables, "genVV_lepton3_imTau"   , cms.string("genVVLeptonimTau(2)")),
        setattr(pt.variables, "genVV_lepton3_oVpid"   , cms.string("genVVLeptonoVPID(2)")),

        setattr(pt.variables, "genVV_S1lepton1_pt"    , cms.string("genVVS1LeptonPt(0)")),
        setattr(pt.variables, "genVV_S1lepton1_pid"   , cms.string("genVVS1LeptonPID(0)")),
        setattr(pt.variables, "genVV_S1lepton1_phi"   , cms.string("genVVS1LeptonPhi(0)")),
        setattr(pt.variables, "genVV_S1lepton1_eta"   , cms.string("genVVS1LeptonEta(0)")),
        setattr(pt.variables, "genVV_S1lepton1_imTau"   , cms.string("genVVS1LeptonimTau(0)")),
        setattr(pt.variables, "genVV_S1lepton1_oVpid"   , cms.string("genVVS1LeptonoVPID(0)")),
        setattr(pt.variables, "genVV_S1lepton2_pt"    , cms.string("genVVS1LeptonPt(1)")),
        setattr(pt.variables, "genVV_S1lepton2_pid"   , cms.string("genVVS1LeptonPID(1)")),
        setattr(pt.variables, "genVV_S1lepton2_phi"   , cms.string("genVVS1LeptonPhi(1)")),
        setattr(pt.variables, "genVV_S1lepton2_eta"   , cms.string("genVVS1LeptonEta(1)")),
        setattr(pt.variables, "genVV_S1lepton2_imTau"   , cms.string("genVVS1LeptonimTau(1)")),
        setattr(pt.variables, "genVV_S1lepton2_oVpid"   , cms.string("genVVS1LeptonoVPID(1)")),
        setattr(pt.variables, "genVV_S1lepton3_pt"    , cms.string("genVVS1LeptonPt(2)")),
        setattr(pt.variables, "genVV_S1lepton3_pid"   , cms.string("genVVS1LeptonPID(2)")),
        setattr(pt.variables, "genVV_S1lepton3_phi"   , cms.string("genVVS1LeptonPhi(2)")),
        setattr(pt.variables, "genVV_S1lepton3_eta"   , cms.string("genVVS1LeptonEta(2)")),
        ...
        setattr(pt.variables, "genVV_neutrino1_eta"   , cms.string("genVVNeutrinoEta(0)")),
        setattr(pt.variables, "genVV_neutrino1_imTau"   , cms.string("genVVNeutrinoimTau(0)")),
        setattr(pt.variables, "genVV_neutrino1_oVpid"   , cms.string("genVVNeutrinooVPID(0)")),
        setattr(pt.variables, "genVV_neutrino2_pt"    , cms.string("genVVNeutrinoPt(1)")),
        setattr(pt.variables, "genVV_neutrino2_pid"   , cms.string("genVVNeutrinoPID(1)")),
        setattr(pt.variables, "genVV_neutrino2_phi"   , cms.string("genVVNeutrinoPhi(1)")),
        setattr(pt.variables, "genVV_neutrino2_eta"   , cms.string("genVVNeutrinoEta(1)")),
        setattr(pt.variables, "genVV_neutrino2_imTau"   , cms.string("genVVNeutrinoimTau(1)")),
        setattr(pt.variables, "genVV_neutrino2_oVpid"   , cms.string("genVVNeutrinooVPID(1)")),
        setattr(pt.variables, "genVV_neutrino3_pt"    , cms.string("genVVNeutrinoPt(2)")),
        setattr(pt.variables, "genVV_neutrino3_pid"   , cms.string("genVVNeutrinoPID(2)")),
        setattr(pt.variables, "genVV_neutrino3_phi"   , cms.string("genVVNeutrinoPhi(2)")),
        setattr(pt.variables, "genVV_neutrino3_eta"   , cms.string("genVVNeutrinoEta(2)")),
        ...
        setattr(pt.variables, "genVV_jet1_pt"    , cms.string("leadingGenJetPt(0)")),
        setattr(pt.variables, "genVV_jet1_phi"   , cms.string("leadingGenJetPhi(0)")),
        setattr(pt.variables, "genVV_jet1_eta"   , cms.string("leadingGenJetEta(0)")),
        setattr(pt.variables, "genVV_jet2_pt"    , cms.string("leadingGenJetPt(1)")),
        setattr(pt.variables, "genVV_jet2_phi"   , cms.string("leadingGenJetPhi(1)")),
        setattr(pt.variables, "genVV_jet2_eta"   , cms.string("leadingGenJetEta(1)")),
        setattr(pt.variables, "genVV_jet3_pt"    , cms.string("leadingGenJetPt(2)")),
        setattr(pt.variables, "genVV_jet3_phi"   , cms.string("leadingGenJetPhi(2)")),
        setattr(pt.variables, "genVV_jet3_eta"   , cms.string("leadingGenJetEta(2)")),
        setattr(pt.variables, "genVV_jet4_pt"    , cms.string("leadingGenJetPt(3)")),
        setattr(pt.variables, "genVV_jet4_phi"   , cms.string("leadingGenJetPhi(3)")),
        setattr(pt.variables, "genVV_jet4_eta"   , cms.string("leadingGenJetEta(3)")),
        setattr(pt.variables, "genVV_jet5_pt"    , cms.string("leadingGenJetPt(4)")),
        setattr(pt.variables, "genVV_jet5_phi"   , cms.string("leadingGenJetPhi(4)")),
        setattr(pt.variables, "genVV_jet5_eta"   , cms.string("leadingGenJetEta(4)")),


    else:
        raise addGenVVVariables, "In addGenTruthVariables, %s doesn't look like a ProbeTreeProducer object, it has no 'variables' attribute." % pt
